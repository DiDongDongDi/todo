...
Future<String?> showSavePlaylistDialog(
  ...
  return showModalBottomSheet<String>(
    ...
    showDragHandle: true,
    useSafeArea: true,
    builder: (context) => _SavePlaylistSheet(defaultTitle: defaultTitle.trim()),
  );
}

class _SavePlaylistSheet extends StatefulWidget {
  const _SavePlaylistSheet({required this.defaultTitle});
    ...
    return Padding(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('保存任务清单', style: theme.textTheme.titleMedium),
